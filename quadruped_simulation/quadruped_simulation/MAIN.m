...
[t,EA,EAd] = fig_plot_only(tout,Xout,Uout,Xdout,Udout,Uext,p);




% %saveas(gcf, 'Hw4_es3_0_m5.pdf')
% fig = gcf;
% exportgraphics(gcf, 'Hw4_es3_5.pdf', 'ContentType', 'vector', 'BackgroundColor', 'none');
% 
